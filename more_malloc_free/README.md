more_malloc_free is a directory that goes through more of the usage of manual memory allocation using malloc
...
2-calloc.c is a function that allocates memory for an array
