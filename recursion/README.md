This README outlines what each function within the recursion directory does
...
6-is_prime_number.c is a function that returns 1 if the input integer is a prime number, otherwise returns 0.
